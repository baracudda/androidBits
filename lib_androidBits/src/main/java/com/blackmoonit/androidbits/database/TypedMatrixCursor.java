...
public class TypedMatrixCursor extends AbstractCursor {
    ...
    public class RowBuilder {
         ...
         *
         * @throws android.database.CursorIndexOutOfBoundsException if you try to add too many values
	 ...
	 */
	public void setOnQueryDataStore(OnQueryDataStore onQueryDataStore) {
