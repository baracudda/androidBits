...
public class RunClickTask extends AsyncTask<View, Object, Object> implements OnClickListener, Runnable {
	...
	public interface TaskDef<T,Q> {
		 ...
		 */
	    public Q doTask(View v, T aBeforeTaskResult, Handler aProgressHandler);
	     ...
	     */
	    public void afterTask(Q aTaskResult);
	}

	protected TaskDef mTaskDef = null;
	protected Handler mProgressHandler = null;
	protected View mViewClicked = null; //needed because onPreExecute has no params
	protected Object mBeforeTaskResult;

	public RunClickTask(Handler aProgressHandler, TaskDef aTaskDef) {
		setTask(aTaskDef);
		setProgressHandler(aProgressHandler);
	}

	public RunClickTask(TaskDef aTaskDef) {
		this(null,aTaskDef);
	}

	public RunClickTask setTask(TaskDef aTaskDef) {
		mTaskDef = aTaskDef;
		if (mTaskDef==null)
	...
	protected void onPreExecute() {
		mBeforeTaskResult = mTaskDef.beforeTask(mViewClicked);
	}
	...
	protected Object doInBackground(View... params) {
		...
		if (params!=null && params.length>0)
			theView = params[0];
   		return mTaskDef.doTask(theView, mBeforeTaskResult, mProgressHandler);
    }
